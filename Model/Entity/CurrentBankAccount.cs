...
namespace Models
{
    ...
    {
        private static new int bankAccountsTotal = 0;
        ...
        public CurrentBankAccount(string bankAccountTitle, decimal openingBalance = 1000) : base(bankAccountTitle, BankAccountType.Current, openingBalance)
        {
            bankAccountsTotal++;
        }
